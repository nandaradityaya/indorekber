  ...
  Widget build(BuildContext context) {
    ...
    return ResponsiveLayout(
      mobileScaffold: Scaffold(
        ...
        body: basicSettings.data.onboardScreen.isEmpty
            ? Container()
            : Stack(
                children: [
                  Obx(() => CustomCachedNetworkImage(
                        imageUrl:
                            "${ApiEndpoint.mainDomain}/${basicSettings.data.imagePath}/${basicSettings.data.onboardScreen[basicController.selectedIndex.value].image}",
                      )),
                  Obx(() => Positioned(
                        bottom: 230,
