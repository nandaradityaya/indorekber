                        ...
                        return Obx(() => CircleSVGButtonWidget(
                              ...
                              textColor: controller.selectedIndex.value == index
                                  ...
                                  : CustomColor.primaryLightTextColor
                                      .withOpacity(.4),
                              name: "",
                              svg: controller.selectedIndex.value == index
                                  ? controller.selectedButtonSVG[index]
                                  : controller.buttonSVG[index],
                            ));
                      },
                      separatorBuilder: (context, i) => horizontalSpace(
                          Dimensions.paddingSizeHorizontal * .5),
