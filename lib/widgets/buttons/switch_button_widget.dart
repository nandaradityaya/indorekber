...
class SwitchButtonWidget extends StatefulWidget {
  const SwitchButtonWidget({super.key, this.onTap, this.isScaffold = false});
        ...
        : Row(
            ...
            children: [
              _btn(context, Strings.buyer, () {
                setState(() {
                  Get.find<UpdateProfileController>().typeIsBuyer.value =
                      !Get.find<UpdateProfileController>().typeIsBuyer.value;
                  widget.onTap!(true);
                });
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.only(
              topLeft: Get.find<LanguageSettingController>()
                      .selectedLanguage
                      .value
                      .contains("ar")
                  ? Radius.circular(isLeft ? 0 : Dimensions.radius)
                  : Radius.circular(isLeft ? Dimensions.radius : 0),
              topRight: Get.find<LanguageSettingController>()
                      .selectedLanguage
                      .value
                      .contains("ar")
                  ? Radius.circular(isLeft ? Dimensions.radius : 0)
                  : Radius.circular(isLeft ? 0 : Dimensions.radius),
              bottomLeft: Get.find<LanguageSettingController>()
                      .selectedLanguage
                      .value
                      .contains("ar")
                  ? Radius.circular(isLeft ? 0 : Dimensions.radius)
                  : Radius.circular(isLeft ? Dimensions.radius : 0),
              bottomRight: Get.find<LanguageSettingController>()
                      .selectedLanguage
                      .value
                      .contains("ar")
                  ? Radius.circular(isLeft ? Dimensions.radius : 0)
